...
#ifndef TFMINI_PLUS_UART_H_
#define TFMINI_PLUS_UART_H_
...
#define UART_HWFC APP_UART_FLOW_CONTROL_DISABLED     /**< No flow control */ 
#define UART_TX_BUF_SIZE 256                         /**< UART TX buffer size. */
#define UART_RX_BUF_SIZE 256                         /**< UART RX buffer size. */

#define TFMP_DEFAULT_ADDRESS   0x10         // default I2C slave address
#define TFMP_SDA               TWI_DATA_Pin // this pin is defined in the board_xm122.h file (Acconeer XM122)
#define TFMP_SCL               TWI_CLK_Pin  // this pin is defined in the board_xm122.h file (Acconeer XM122)
 ...
 */
uint8_t tfmp_write_cmd(uint32_t cmnd, uint32_t param, uint8_t * version);
 ...
 * @return TFMP_READY:    everything should be good
 */
uint8_t tfmp_cmd_reply(uint32_t cmnd, uint32_t param, uint8_t * reply);
 ...
 * @return TFMP_CHECKSUM: if checksum errors occurs, i.e., transmission is temporary interfered 
 */
uint8_t tfmp_init(uint16_t * sample_frequency);
